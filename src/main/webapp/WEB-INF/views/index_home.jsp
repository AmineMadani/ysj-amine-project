...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    ...
	    <p><strong>Address:</strong>  York St John University, Lord Mayor’s Walk, York, YO31 7EX </p> 
	    <p><strong>Ph No: </strong> 01904624624 </p>
		<p><strong>E-Mail ID :</strong>  aminemadani1999@gmail.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2023 <a href="#"  target="_blank" class="w3-hover-text-green"> yorksj.ac.uk</a></p>
</footer>
